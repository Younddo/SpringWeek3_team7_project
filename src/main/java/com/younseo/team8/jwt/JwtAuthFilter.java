...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    private final com.younseo.team8.jwt.JwtUtil jwtUtil;
            ...
            if (!jwtUtil.validateAccessToken(accessToken)) {
                ...
                if (refreshToken != null) {
                    ...
                    if(!fin) {
                        ...
                        response.addHeader(com.younseo.team8.jwt.JwtUtil.ACCESS, jwtUtil.createAccessToken(jwtUtil.getEmailFromToken(refreshToken)));
                        response.addHeader(com.younseo.team8.jwt.JwtUtil.REFRESH, newRefreshToken);
